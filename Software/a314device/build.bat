...
vc -DMODEL_FE=1 romtag.asm driver_task.c debug.c device.c startup.c sockets.c pi_if_fe.c int_server_fe.asm fix_mem_region.c -O3 -nostdlib -o a314-fe.device
